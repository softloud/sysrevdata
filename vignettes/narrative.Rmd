...
buffer_example %>% 
  pivot_longer(
    cols = contains(variables_to_condense),
    names_to = "category",
...
buffer_example_long %>% 
  select(short_title, category, subcategory) %>% View()

```

For this section, we'll pretend the `bufferstrips` dataset is long, using this dataframe.
