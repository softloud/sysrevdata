...
In addition to a narrative synthesis table, systematic reviews require complex visualisations, such as systematics maps, and summaries of particular components, such as the number of countries considered in a study. The easiest way to do this is to produce a **long** or **tidy** format, one variable per study per row. 
